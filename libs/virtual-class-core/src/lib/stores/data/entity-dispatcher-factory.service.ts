...
export class LiftEntityDispatcherBase<T> extends EntityDispatcherBase<T> {
...
@Injectable()
export class LiftEntityDispatcherFactory implements OnDestroy {
  /**
  ...
  create<T>(
    ...
    return new LiftEntityDispatcherBase<T>(
      entityName,
...
export const ENTITY_DISPATCHER_FACTORY_PROVIDER = {
  ...
  useClass: LiftEntityDispatcherFactory,
};
